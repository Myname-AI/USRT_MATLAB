function [ErrorMap, position, N_theta, N_x, N_y] = ErrMap2DFunc(positionRESULTS,ErrorFunc_2D)

xSTART = 10; 
 xSEP=5 ; %xLENGHT, ySTART, ySTEP, yLENGHT, angleSTART, angleSTEP, angleLENGHT
xLENGTH=40;
